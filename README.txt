...
a persistence unit "eva62GuamanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Guaman/pom.xml":
...
artifact ("eva62Guaman.war") is already built. You can build
